document.addEventListener(
	...
	() => {
		...
		const simpleEventDateChannel = nfRadio.channel("actionSetting-icalendar_date");
		const simpleEventTimeStartChannel = nfRadio.channel("actionSetting-icalendar_time_start");
		const simpleEventTimeEndChannel = nfRadio.channel("actionSetting-icalendar_time_end");
...
;
				var value = dataModel.get('icalendar_date').trim();
			...
			timeStart(dataModel, settingModel) {
				...
				var value = dataModel.get('icalendar_time_start').trim();
			...
			timeEnd(dataModel, settingModel) {
				...
				var value = dataModel.get('icalendar_time_end').trim();
